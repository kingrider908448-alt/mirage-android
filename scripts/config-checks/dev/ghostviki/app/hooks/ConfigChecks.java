...
public final class ConfigChecks {
    ...
    public static void main(String[] args) {
        ...
        check(alphaReader.diagnostics().startsWith("PROFILE_READY schema=4 generation=1"), "Diagnostic reports loaded schema and generation, not a spoof verdict");
        ...
        check(upgraded.preferences.getInt("schema", 0) == 4, "Upgrade publishes schema 4");
